...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div className="p-4 shadow-lg hover:shadow-xl transition-shadow duration-300 min-w-[400] min-h-[800]" onClick={() => handleCardClick(project.id)}>
      {/* <img src={project.previewPicture == '' || 'videoBanne' ? '/noImage' : project.previewPicture} alt={project.previewPicture} /> */}
      <img src={project.previewPicture} alt='Project Preview' className='mx-auto mb-6 aspect-video min-w-[400]'/>
      <h2 className='size-1 text-blue-500 mb-6'>videoBanne{project.technologyTag}</h2>
